...
Core objects reject unknown fields. Forward-compatible additions use namespaced `extensions`. JSON Schema covers shape; repository semantic checks cover runtime and knowledge graphs, review and tuning lifecycles, validation summaries, durable Operations, identity, geometry, object integrity, and Commit identity.
