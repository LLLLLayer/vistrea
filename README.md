...
relay. These server surfaces are code-complete but await the paused verification
gate; organization/team inheritance, permission mutation, discovery,
subscriptions, and Studio sync remain follow-up work.
