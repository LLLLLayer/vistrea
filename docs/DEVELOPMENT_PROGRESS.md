...
2. Expand Agent operations, Skills, and CI to the full stable Engine surface, then the optional Vistrea Hub synchronization layer.
3. Deepen Canvas curation, Wiki editing in Studio, validator configuration, and baseline-classified build regressions after the agent surface stabilizes.
